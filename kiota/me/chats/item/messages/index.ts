...
// @ts-ignore
import { createChatMessageCollectionResponseFromDiscriminatorValue, createChatMessageFromDiscriminatorValue, serializeChatMessage, type ChatMessage, type ChatMessageCollectionResponse } from '../../../../models/index.js';
// @ts-ignore
...
// @ts-ignore
import { ChatMessageItemRequestBuilderNavigationMetadata, type ChatMessageItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface MessagesRequestBuilder extends BaseRequestBuilder<MessagesRequestBuilder> {
    ...
    /**
     * Gets an item from the ApiSDK.me.chats.item.messages.item collection
 ...
 */
export const MessagesRequestBuilderUriTemplate = "{+baseurl}/me/chats/{chat%2Did}/messages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
